...
export default function OnlyBartMediaPage() {
  useObSprites()
  ...
  return (
    <div className="m-ua-windows">
      ...
      <div className="b-profile__user d-flex align-items-start"><a href="https://hd1920x1080.de/ob/hd1920x1080" className="g-avatar m-reset-wcag-link-focus m-guest online_status_class online m-w100 m-reset-wcag-link-focus">
      ...
      <div className="b-tabs__nav m-tabs-default m-flex-width m-size-md mb-0 js-tabs-switchers m-over-separator m-nv"><ul className="b-dragscroll m-native-custom-scrollbar m-scrollbar-x m-invisible-scrollbar b-tabs__nav__list m-scroll-behavior m-reset-overscroll"><li className="b-tabs__nav__item"><a href="/onlybart/posts" className="b-tabs__nav__link m-reset-wcag-link-focus router-link-active m-with-rectangle-hover m-tb-sm" id="profilePostTab" tabIndex={0} data-saveprevquery="true"><span className="b-tabs__nav__text"> 1 Beitrag </span></a></li><li className="b-tabs__nav__item"><a href="." aria-current="page" className="b-tabs__nav__link m-reset-wcag-link-focus router-link-active m-with-rectangle-hover m-tb-sm router-link-active m-current" id="m-with-rectangle-hover-m-tb-sm,[object-Object]/hd1920x1080/media27-Medien" tabIndex={0} data-saveprevquery="true"><span className="b-tabs__nav__text"> 27 Medien </span></a></li></ul></div>
      </div>
      </div>
      ...
      <div className="b-tabs__nav m-nv m-tab-rounded m-single-current mb-0"><ul className="b-dragscroll m-native-custom-scrollbar m-scrollbar-x m-invisible-scrollbar b-tabs__nav__list m-scroll-behavior m-reset-overscroll m-gaps-inside m-gaps-outside"><li className="b-tabs__nav__item"><a href="." id="/hd1920x1080/mediaAlle-27" tabIndex={-1} className="b-tabs__nav__link m-reset-wcag-link-focus m-current m-no-pointer"><span className="b-tabs__nav__text"> Alle 27 </span></a></li><li className="b-tabs__nav__item"><a href="/onlybart/photos" id="/hd1920x1080/photosFoto-25" tabIndex={0} className="b-tabs__nav__link m-reset-wcag-link-focus"><span className="b-tabs__nav__text"> Foto 25 </span></a></li><li className="b-tabs__nav__item"><a href="/onlybart/videos" id="/hd1920x1080/videosVideo-2" tabIndex={0} className="b-tabs__nav__link m-reset-wcag-link-focus"><span className="b-tabs__nav__text"> Video 2 </span></a></li></ul></div>
