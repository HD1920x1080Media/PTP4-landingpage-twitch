...
export default function OnlyBartVideosPage() {
  useObSprites()
  ...
  return (
    <div className="m-ua-windows">
      ...
      <div className="b-profile__user d-flex align-items-start"><a href="/onlybart/posts" className="g-avatar m-reset-wcag-link-focus m-guest online_status_class online m-w100 m-reset-wcag-link-focus">
      ...
      <div className="b-tabs__nav m-tabs-default m-flex-width m-size-md mb-0 js-tabs-switchers m-over-separator m-nv"><ul className="b-dragscroll m-native-custom-scrollbar m-scrollbar-x m-invisible-scrollbar b-tabs__nav__list m-scroll-behavior m-reset-overscroll"><li className="b-tabs__nav__item"><a href="/onlybart/posts" className="b-tabs__nav__link m-reset-wcag-link-focus router-link-active m-with-rectangle-hover m-tb-sm" id="profilePostTab" tabIndex={0} data-saveprevquery="true"><span className="b-tabs__nav__text"> 1 Beitrag </span></a></li><li className="b-tabs__nav__item"><a href="/onlybart/media" className="b-tabs__nav__link m-reset-wcag-link-focus m-with-rectangle-hover m-tb-sm router-link-active m-current" id="m-with-rectangle-hover-m-tb-sm,[object-Object]/hd1920x1080/media27-Medien" tabIndex={0} data-saveprevquery="true"><span className="b-tabs__nav__text"> 27 Medien </span></a></li></ul></div>
      </div>
      </div>

      <div className="g-sides-gaps">
      <div className="b-content-filter-wrapper m-grid-mode">
      ...
      <div className="b-content-filter__btn"><button className="g-btn m-icon m-icon-only m-gray m-sm-size m-with-round-hover m-icon-size-lg has-tooltip" data-original-title="null" aria-label="Vollständige Ansicht"><svg data-icon-name="icon-view-full" aria-hidden="true" className="g-icon"><use href="#icon-view-full"></use></svg></button></div>
      ...
      <div className="b-tabs__nav m-nv m-tab-rounded m-single-current mb-0"><ul className="b-dragscroll m-native-custom-scrollbar m-scrollbar-x m-invisible-scrollbar b-tabs__nav__list m-scroll-behavior m-reset-overscroll m-gaps-inside m-gaps-outside"><li className="b-tabs__nav__item"><a href="/onlybart/media" id="/hd1920x1080/mediaAlle-27" tabIndex={0} className="b-tabs__nav__link m-reset-wcag-link-focus"><span className="b-tabs__nav__text"> Alle 27 </span></a></li><li className="b-tabs__nav__item"><a href="/onlybart/photos" id="/hd1920x1080/photosFoto-25" tabIndex={0} className="b-tabs__nav__link m-reset-wcag-link-focus"><span className="b-tabs__nav__text"> Foto 25 </span></a></li><li className="b-tabs__nav__item"><a href="." id="/hd1920x1080/videosVideo-2" tabIndex={-1} className="b-tabs__nav__link m-reset-wcag-link-focus m-current m-no-pointer"><span className="b-tabs__nav__text"> Video 2 </span></a></li></ul></div>
      ...
      <a href="mailto:admin@hd1920x1080.de?subject=OnlyBart%20Anfrage" className="contact_button m-reset-wcag-link-focus visible-lg has-tooltip" data-original-title="null" aria-label="Hilfe &amp; Support"><svg data-icon-name="icon-support" aria-hidden="true" className="g-icon"><use href="#icon-support"></use></svg></a>
