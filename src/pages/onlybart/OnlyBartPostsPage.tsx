...
export default function OnlyBartPostsPage() {
  useObSprites()
  ...
  return (
    <div className="m-ua-windows">
      ...
      <div className="dropdown b-dropdown m-row dropright position-static btn-group" id="__BVID__40"><button tabIndex={-1} aria-haspopup="menu" aria-expanded="false" type="button" className="btn dropdown-toggle btn-secondary" id="__BVID__40__BV_toggle_"><span className="m-globe"><svg className="l-sidebar__menu__icon g-icon" data-icon-name="icon-language" aria-hidden="true"><use href="#icon-language"></use></svg></span><span className="b-lang-text g-text-ellipsis"> German </span><span className="b-icon-arrow"><svg className="g-icon" data-icon-name="icon-arrow-down" aria-hidden="true"><use href="#icon-arrow-down"></use></svg></span></button><ul role="menu" tabIndex={-1} className="dropdown-menu m-not-fixed-dropdown m-lang-switcher pt-0 pb-0" aria-labelledby="__BVID__40__BV_toggle_"></ul></div>
      </div>
      ...
      <div className="b-profile__user d-flex align-items-start"><a href="." className="g-avatar m-reset-wcag-link-focus m-guest online_status_class online m-w100 m-reset-wcag-link-focus">
      ...
      <div className="b-tabs__nav m-tabs-default m-flex-width m-size-md mb-0 js-tabs-switchers m-over-separator m-nv"><ul className="b-dragscroll m-native-custom-scrollbar m-scrollbar-x m-invisible-scrollbar b-tabs__nav__list m-scroll-behavior m-reset-overscroll"><li className="b-tabs__nav__item"><a href="." aria-current="page" className="b-tabs__nav__link m-reset-wcag-link-focus router-link-active m-with-rectangle-hover m-tb-sm m-current" id="profilePostTab" tabIndex={0} data-saveprevquery="true"><span className="b-tabs__nav__text"> 1 Beitrag </span></a></li><li className="b-tabs__nav__item"><a href="/onlybart/media" className="b-tabs__nav__link m-reset-wcag-link-focus m-with-rectangle-hover m-tb-sm" id="m-with-rectangle-hover-m-tb-sm,[object-Object]/hd1920x1080/media27-Medien" tabIndex={0} data-saveprevquery="true"><span className="b-tabs__nav__text"> 27 Medien </span></a></li></ul></div>
      </div>
      </div>

      <div className="g-sides-gaps">
      <div className="b-content-filter-wrapper">
      ...
      <div className="b-content-filter__btn"><button className="g-btn m-icon m-icon-only m-gray m-sm-size m-with-round-hover m-icon-size-lg has-tooltip" data-original-title="null" aria-label="Kompakte Ansicht"><svg data-icon-name="icon-view-grid" aria-hidden="true" className="g-icon"><use href="#icon-view-grid"></use></svg></button></div>

      <div className="b-content-filter__btn">
      <div className="dropdown b-dropdown position-static btn-group has-tooltip" data-original-title="null" aria-label="Sortieren" id="__BVID__90"><button aria-haspopup="menu" aria-expanded="false" type="button" className="btn dropdown-toggle btn-secondary g-btn m-gray m-with-round-hover m-icon m-icon-only m-sm-size" id="__BVID__90__BV_toggle_"><svg data-icon-name="icon-sort" aria-hidden="true" className="g-icon"><use href="#icon-sort"></use></svg></button><ul role="menu" tabIndex={-1} className="dropdown-menu dropdown-menu-right" aria-labelledby="__BVID__90__BV_toggle_"></ul></div>
      </div>
      </div>
      </div>
      </div>
