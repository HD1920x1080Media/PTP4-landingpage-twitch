...
export default function OnlyBartPhotosPage() {
  useObSprites()
  ...
  return (
    <div className="m-ua-windows">
      ...
      <div className="b-tabs__nav m-nv m-tab-rounded m-single-current mb-0"><ul className="b-dragscroll m-native-custom-scrollbar m-scrollbar-x m-invisible-scrollbar b-tabs__nav__list m-scroll-behavior m-reset-overscroll m-gaps-inside m-gaps-outside"><li className="b-tabs__nav__item"><a href="/onlybart/media" id="/hd1920x1080/mediaAlle-27" tabIndex={0} className="b-tabs__nav__link m-reset-wcag-link-focus"><span className="b-tabs__nav__text"> Alle 27 </span></a></li><li className="b-tabs__nav__item"><a href="." id="/hd1920x1080/photosFoto-25" tabIndex={-1} className="b-tabs__nav__link m-reset-wcag-link-focus m-current m-no-pointer"><span className="b-tabs__nav__text"> Foto 25 </span></a></li><li className="b-tabs__nav__item"><a href="/onlybart/videos" id="/hd1920x1080/videosVideo-2" tabIndex={0} className="b-tabs__nav__link m-reset-wcag-link-focus"><span className="b-tabs__nav__text"> Video 2 </span></a></li></ul></div>
